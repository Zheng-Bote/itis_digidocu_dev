#ifndef ANNEXDATAOBJECT_H
#define ANNEXDATAOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT AnnexDataObject : public TSqlObject, public QSharedData
{
public:
    int id {0};
    QString lfdnr;
    ...
    QString tableName() const override { return QStringLiteral("annex_data"); }
