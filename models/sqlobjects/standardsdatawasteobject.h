#ifndef STANDARDSDATAWASTEOBJECT_H
#define STANDARDSDATAWASTEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT StandardsDataWasteObject : public TSqlObject, public QSharedData
{
public:
    int id {0};
    ...
    QString tableName() const override { return QStringLiteral("standards_data_waste"); }
...
#endif // STANDARDSDATAWASTEOBJECT_H
