#ifndef STANDARDSMETAOBJECT_H
#define STANDARDSMETAOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT StandardsMetaObject : public TSqlObject, public QSharedData
{
public:
    int id {0};
    int spec_data_id {0};
    ...
    QString tableName() const override { return QStringLiteral("standards_meta"); }
