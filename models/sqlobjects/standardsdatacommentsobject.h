#ifndef STANDARDSDATACOMMENTSOBJECT_H
#define STANDARDSDATACOMMENTSOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT StandardsDataCommentsObject : public TSqlObject, public QSharedData
{
public:
    int id {0};
    ...
    QString tableName() const override { return QStringLiteral("standards_data_comments"); }
...
#endif // STANDARDSDATACOMMENTSOBJECT_H
