#ifndef ANNEXDATAWASTEOBJECT_H
#define ANNEXDATAWASTEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT AnnexDataWasteObject : public TSqlObject, public QSharedData
{
public:
    int id {0};
    ...
    QString tableName() const override { return QStringLiteral("annex_data_waste"); }
