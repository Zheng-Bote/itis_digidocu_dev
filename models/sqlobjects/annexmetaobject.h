#ifndef ANNEXMETAOBJECT_H
#define ANNEXMETAOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT AnnexMetaObject : public TSqlObject, public QSharedData
{
public:
    int id {0};
    int spec_data_id {0};
    ...
    QString tableName() const override { return QStringLiteral("annex_meta"); }
