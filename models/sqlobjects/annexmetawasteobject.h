#ifndef ANNEXMETAWASTEOBJECT_H
#define ANNEXMETAWASTEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT AnnexMetaWasteObject : public TSqlObject, public QSharedData
{
public:
    int id {0};
    ...
    QString tableName() const override { return QStringLiteral("annex_meta_waste"); }
