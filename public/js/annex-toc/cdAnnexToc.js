...
class AnnexToc extends HTMLElement 
{
	constructor() 
	{
		super();
	...
	getGlossar() 
	{
		//data = new URLSearchParams([["getStdType", "show"], ["obj_sname", "Annex B-3"], ["cat_sname_en", "Planning"], ["country", "WW"], ["lang", "de_DE"], ["spec_active", "1"], ["ac_class", "1"], ["pc_class", "1"], ["spec_release", "draft"]]);
		data = new URLSearchParams([["getStdType", "show"], ["obj_sname", document.getElementById("obj_name").value], ["cat_sname_en", document.getElementById("cat").value], ["country", document.getElementById("countries").value], ["lang", document.getElementById("lang").value], ["spec_active", "1"], ["ac_class", document.getElementById("ac_classes").value], ["pc_class", document.getElementById("pc_classes").value], ["spec_release", "released"]]);
	  return new Promise((res, rej) => {
		fetch('/releasemgmt/getAnnexToc',
		{
			body: data,
			method: "post"
		})
	...
	renderGlossar(data) 
	{
		...
		for (i in obj) 
        {
			...
			{
				item_cat_title = translate(obj[i].cat_class);
			}
...
customElements.define("annex-toc", AnnexToc);
