...
class T_VIEW_EXPORT annexdata_listWasteView : public TActionView
{
  Q_OBJECT
public:
  annexdata_listWasteView() : TActionView() { }
  QString toString();
};

QString annexdata_listWasteView::toString()
{
  responsebody.reserve(8997);
...
T_DEFINE_VIEW(annexdata_listWasteView)

#include "annexdata_listWasteView.moc"
