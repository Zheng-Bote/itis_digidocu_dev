...
class T_VIEW_EXPORT glossar_list_allView : public TActionView
{
  Q_OBJECT
public:
  glossar_list_allView() : TActionView() { }
  QString toString();
};

QString glossar_list_allView::toString()
{
  responsebody.reserve(5308);
...
T_DEFINE_VIEW(glossar_list_allView)

#include "glossar_list_allView.moc"
