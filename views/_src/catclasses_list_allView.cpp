...
class T_VIEW_EXPORT catclasses_list_allView : public TActionView
{
  Q_OBJECT
public:
  catclasses_list_allView() : TActionView() { }
  QString toString();
};

QString catclasses_list_allView::toString()
{
  responsebody.reserve(5772);
  ...
  tfetch(QList<CatClasses>, catClassesList);
  for (const auto &i : catClassesList) {
  responsebody += QStringLiteral("  <tr>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.id());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.catLnameDe());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.catSnameDe());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.descDe());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.catLnameEn());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.catSnameEn());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.descEn());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.classType());
  responsebody += QStringLiteral("</td>\n    <td>");
...
T_DEFINE_VIEW(catclasses_list_allView)

#include "catclasses_list_allView.moc"
