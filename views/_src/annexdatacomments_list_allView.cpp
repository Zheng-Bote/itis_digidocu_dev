...
class T_VIEW_EXPORT annexdatacomments_list_allView : public TActionView
{
  Q_OBJECT
public:
  annexdatacomments_list_allView() : TActionView() { }
  QString toString();
};

QString annexdatacomments_list_allView::toString()
{
  responsebody.reserve(6690);
  ...
  tfetch(QList<AnnexDataComments>, annexDataCommentsList);
  for (const auto &i : annexDataCommentsList) {
...
T_DEFINE_VIEW(annexdatacomments_list_allView)

#include "annexdatacomments_list_allView.moc"
