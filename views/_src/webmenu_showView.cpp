...
class T_VIEW_EXPORT webmenu_showView : public TActionView
{
  Q_OBJECT
public:
  webmenu_showView() : TActionView() { }
  QString toString();
};

QString webmenu_showView::toString()
{
  responsebody.reserve(6651);
  responsebody += QStringLiteral("<!DOCTYPE html>\n");
    tfetch(Webmenu, webmenu);
  ...
  responsebody += QStringLiteral("\" class=\"w3-btn w3-light-grey\"><img src=\"/Icons/pencil.svg\">&nbsp;Q-Edit</a>\n<a href=\"/webmenu/list_all\" class=\"w3-btn w3-light-grey\"><img src=\"/Icons/justify.svg\">&nbsp;zur&uuml;ck</a>\n<br>\n\n<div class=\"w3-container\" style=\"max-width: 50%;\">\n  <p>\n    <label>ID<br /><input type=\"text\" class=\"w3-input\" name=\"objects[id]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu.id());
  responsebody += QStringLiteral("\" readonly=\"readonly\" /></label>\n  </p>\n  <p>\n    <label>Mnu ID<br /><input type=\"text\" class=\"w3-input\" name=\"objects[objSname]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu.mnuId());
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>MnuSub ID<br /><input type=\"text\" class=\"w3-input\" name=\"objects[objLnameDe]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu.mnuSubId());
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Name De<br /><input type=\"text\" class=\"w3-input\" name=\"objects[descDe]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu.nameDe());
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Desc De<br /><input type=\"text\" class=\"w3-input\" name=\"objects[objLnameEn]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu.descDe());
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Name En<br /><input type=\"text\" class=\"w3-input\" name=\"objects[descEn]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu.nameEn());
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Desc En<br /><input type=\"text\" class=\"w3-input\" name=\"objects[sort]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu.descEn());
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Uri<br /><input type=\"text\" class=\"w3-input\" name=\"objects[active]\" value=\"");
  ...
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Mnu Item<br /><input type=\"text\" class=\"w3-input\" name=\"objects[groups]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu.mnuItem());
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Sort<br /><input type=\"text\" class=\"w3-input\" name=\"objects[groups]\" value=\"");
...
T_DEFINE_VIEW(webmenu_showView)

#include "webmenu_showView.moc"
