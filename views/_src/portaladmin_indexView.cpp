...
class T_VIEW_EXPORT portaladmin_indexView : public TActionView
{
  Q_OBJECT
public:
  portaladmin_indexView() : TActionView() { }
  QString toString();
};

QString portaladmin_indexView::toString()
{
  responsebody.reserve(2425);
...
T_DEFINE_VIEW(portaladmin_indexView)

#include "portaladmin_indexView.moc"
