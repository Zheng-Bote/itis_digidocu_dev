...
class T_VIEW_EXPORT annexdata_showAnnexElectronView : public TActionView
{
  Q_OBJECT
public:
  annexdata_showAnnexElectronView() : TActionView() { }
  QString toString();
};

QString annexdata_showAnnexElectronView::toString()
{
  responsebody.reserve(6505);
...
T_DEFINE_VIEW(annexdata_showAnnexElectronView)

#include "annexdata_showAnnexElectronView.moc"
