...
class T_VIEW_EXPORT itisnews_list_allView : public TActionView
{
  Q_OBJECT
public:
  itisnews_list_allView() : TActionView() { }
  QString toString();
};

QString itisnews_list_allView::toString()
{
  responsebody.reserve(6560);
  ...
  techoex(green_msg);
  tehex(notice);
  responsebody += QStringLiteral("</p>\n\n<main>\n<div id=\"pagecontent\"><page-content message=\"\"></page-content></div>\n\n<div id=\"prio_legend\"></div>\n\n<br />\n<table class=\"w3-table-all w3-hoverable sortable\" id=\"myTable\">\n  <tr class=\"w3-text-grey\">\n    <th>ID</th>\n    <th>News Type</th>\n    <th>News Type Sub</th>\n    <th>News Title De</th>\n<!--    <th>News Title En</th> -->\n    <th>News Desc De</th>\n<!--    <th>News Desc En</th> -->\n    <th>News Text De</th>\n<!--    <th>News Text En</th> -->\n    <th>News Prio</th>\n    <th>Author</th>\n    <th>News Created</th>\n    <th>News Valid Start</th>\n    <th>News Valid End</th>\n    <th style=\"width:120px;\">Baustein</th>\n  </tr>\n");
  tfetch(QList<ItisNews>, itisNewsList);
  for (const auto &i : itisNewsList) {
  responsebody += QStringLiteral("  <tr>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.id());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsType());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsTypeSub());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsTitleDe());
  responsebody += QStringLiteral("</td>\n<!--    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsTitleEn());
  responsebody += QStringLiteral("</td> -->\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsDescDe());
  responsebody += QStringLiteral("</td>\n<!--    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsDescEn());
  responsebody += QStringLiteral("</td> -->\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsTextDe());
  responsebody += QStringLiteral("</td>\n<!--    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsTextEn());
  responsebody += QStringLiteral("</td> -->\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsPrio());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.author());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsCreated());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsValidStart());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.newsValidEnd());
...
T_DEFINE_VIEW(itisnews_list_allView)

#include "itisnews_list_allView.moc"
