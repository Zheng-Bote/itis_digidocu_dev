...
QString releasemgmt_listAllStdCdView::toString()
{
  ...
  responsebody += QStringLiteral("</span>&nbsp;<span>");
  tehex(notice);
  responsebody += QStringLiteral("</span>\n</span>\n\n<main>\n<div id=\"pagecontent\"><page-content message=\"\"></page-content></div>\n\n<br />\n\n<section>\n	<h4>Standard CD</h4>\n	<div id=\"example-table\"></div>\n</section>\n\n<section>\n	<h4>Standard CD PDF's</h4>\n		<span id=\"standard\"></span>\n</section>\n\n</main>\n<itis-footer id=\"itisFooter\" message=\"\"></itis-footer>\n  \n</body>\n</html>\n");

  return responsebody;
}

T_DEFINE_VIEW(releasemgmt_listAllStdCdView)

#include "releasemgmt_listAllStdCdView.moc"
