...
class T_VIEW_EXPORT catclasses_showView : public TActionView
{
  Q_OBJECT
public:
  catclasses_showView() : TActionView() { }
  QString toString();
};

QString catclasses_showView::toString()
{
  responsebody.reserve(6273);
  responsebody += QStringLiteral("<!DOCTYPE html>\n");
    tfetch(CatClasses, catClasses);
  ...
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Class Type<br /><input type=\"text\" class=\"w3-input\" name=\"objects[sort]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses.classType());
  responsebody += QStringLiteral("\" readonly /></label>\n  </p>\n  <p>\n    <label>Groups<br /><input type=\"text\" class=\"w3-input\" name=\"objects[active]\" value=\"");
...
T_DEFINE_VIEW(catclasses_showView)

#include "catclasses_showView.moc"
