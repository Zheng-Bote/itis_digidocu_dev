...
class T_VIEW_EXPORT acclasses_list_allView : public TActionView
{
  Q_OBJECT
public:
  acclasses_list_allView() : TActionView() { }
  QString toString();
};

QString acclasses_list_allView::toString()
{
  responsebody.reserve(4878);
  ...
  tfetch(QList<AcClasses>, acClassesList);
  for (const auto &i : acClassesList) {
...
T_DEFINE_VIEW(acclasses_list_allView)

#include "acclasses_list_allView.moc"
