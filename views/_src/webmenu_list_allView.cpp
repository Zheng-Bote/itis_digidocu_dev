...
class T_VIEW_EXPORT webmenu_list_allView : public TActionView
{
  Q_OBJECT
public:
  webmenu_list_allView() : TActionView() { }
  QString toString();
};

QString webmenu_list_allView::toString()
{
  responsebody.reserve(5768);
  ...
  responsebody += THttpUtility::htmlEscape(i.mnuId());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.mnuSubId());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.nameDe());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.descDe());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.nameEn());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.descEn());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.mnuUri());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.groups());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.mnuItem());
  responsebody += QStringLiteral("</td>\n    <td>");
...
T_DEFINE_VIEW(webmenu_list_allView)

#include "webmenu_list_allView.moc"
