...
class T_VIEW_EXPORT account_userhomeElectronView : public TActionView
{
  Q_OBJECT
public:
  account_userhomeElectronView() : TActionView() { }
  QString toString();
};

QString account_userhomeElectronView::toString()
{
  responsebody.reserve(7495);
  ...
  responsebody += QStringLiteral("</b>&nbsp;<small>(<a href=\"/account/userPwdElectron\" title=\"change Password now\">Passwort jetzt &auml;ndern</a>)</small>\n	</section>\n	\n	<section id = \"userData\">\n		\n		<div class=\"w3-card-4\">\n						<div class=\"w3-container\">\n			<img src=\"/images/robot-head.svg\" alt=\"Alps\" style=\"width:20%;float:right;\">\n\n				<p>username: <span id=\"username\">");
  techoex(username);
...
T_DEFINE_VIEW(account_userhomeElectronView)

#include "account_userhomeElectronView.moc"
