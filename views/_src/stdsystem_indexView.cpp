...
class T_VIEW_EXPORT stdsystem_indexView : public TActionView
{
  Q_OBJECT
public:
  stdsystem_indexView() : TActionView() { }
  QString toString();
};

QString stdsystem_indexView::toString()
{
  ...
  responsebody += THttpUtility::htmlEscape(controller()->name());
  responsebody += QStringLiteral("\"></itis-menusub>\n\n<h3 id=\"pagetitle\"><page-title message=\"\">Portal-Admin</page-title></h3>\n<div id=\"pagedesc\"><page-desc message=\"\"></page-desc></div>\n\n<p id=\"redmsg\" style=\"color: red\">");
  techoex(red_msg);
  tehex(error);
...
T_DEFINE_VIEW(stdsystem_indexView)

#include "stdsystem_indexView.moc"
