...
class T_VIEW_EXPORT acclasses_saveView : public TActionView
{
  Q_OBJECT
public:
  acclasses_saveView() : TActionView() { }
  QString toString();
};

QString acclasses_saveView::toString()
{
  ...
  responsebody += QVariant(formTag(urla("save", acClasses["id"]), Tf::Post)).toString();
  responsebody += QStringLiteral("\n  <p>\n    <label>ID<br /><input class=\"w3-input\" type=\"text\" name=\"acClasses[id]\" value=\"");
  responsebody += THttpUtility::htmlEscape(acClasses["id"]);
  responsebody += QStringLiteral("\" readonly=\"readonly\" /></label>\n  </p>\n  <p>\n    <label>Obj Sname<br /><input class=\"w3-input\" type=\"text\" name=\"acClasses[objSname]\" value=\"");
  responsebody += THttpUtility::htmlEscape(acClasses["objSname"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Ac Class<br /><input class=\"w3-input\" type=\"text\" name=\"acClasses[acClass]\" value=\"");
  responsebody += THttpUtility::htmlEscape(acClasses["acClass"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Class Type<br /><input class=\"w3-input\" type=\"text\" name=\"acClasses[classType]\" value=\"");
  responsebody += THttpUtility::htmlEscape(acClasses["classType"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Active<br /><input class=\"w3-input\" type=\"text\" name=\"acClasses[active]\" value=\"");
...
T_DEFINE_VIEW(acclasses_saveView)

#include "acclasses_saveView.moc"
