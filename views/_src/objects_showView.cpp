...
class T_VIEW_EXPORT objects_showView : public TActionView
{
  Q_OBJECT
public:
  objects_showView() : TActionView() { }
  QString toString();
};

QString objects_showView::toString()
{
  responsebody.reserve(5992);
...
T_DEFINE_VIEW(objects_showView)

#include "objects_showView.moc"
