...
class T_VIEW_EXPORT objects_indexView : public TActionView
{
  Q_OBJECT
public:
  objects_indexView() : TActionView() { }
  QString toString();
};

QString objects_indexView::toString()
{
...
T_DEFINE_VIEW(objects_indexView)

#include "objects_indexView.moc"
