...
class T_VIEW_EXPORT pcclasses_saveView : public TActionView
{
  Q_OBJECT
public:
  pcclasses_saveView() : TActionView() { }
  QString toString();
};

QString pcclasses_saveView::toString()
{
  responsebody.reserve(4542);
  ...
  responsebody += QVariant(formTag(urla("save", pcClasses["id"]), Tf::Post)).toString();
  responsebody += QStringLiteral("\n  <p>\n    <label>ID<br /><input class=\"w3-input\" type=\"text\" name=\"pcClasses[id]\" value=\"");
  responsebody += THttpUtility::htmlEscape(pcClasses["id"]);
  responsebody += QStringLiteral("\" readonly=\"readonly\" /></label>\n  </p>\n  <p>\n    <label>Obj Sname<br /><input class=\"w3-input\" type=\"text\" name=\"pcClasses[objSname]\" value=\"");
  responsebody += THttpUtility::htmlEscape(pcClasses["objSname"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Pc Class<br /><input class=\"w3-input\" type=\"text\" name=\"pcClasses[pcClass]\" value=\"");
  responsebody += THttpUtility::htmlEscape(pcClasses["pcClass"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Class Type<br /><input class=\"w3-input\" type=\"text\" name=\"pcClasses[classType]\" value=\"");
  responsebody += THttpUtility::htmlEscape(pcClasses["classType"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Active<br /><input class=\"w3-input\" type=\"text\" name=\"pcClasses[active]\" value=\"");
...
T_DEFINE_VIEW(pcclasses_saveView)

#include "pcclasses_saveView.moc"
