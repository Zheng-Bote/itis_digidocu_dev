...
class T_VIEW_EXPORT actionrights_createView : public TActionView
{
  Q_OBJECT
public:
  actionrights_createView() : TActionView() { }
  QString toString();
};

QString actionrights_createView::toString()
{
  responsebody.reserve(6111);
...
T_DEFINE_VIEW(actionrights_createView)

#include "actionrights_createView.moc"
