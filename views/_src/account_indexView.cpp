...
class T_VIEW_EXPORT account_indexView : public TActionView
{
  Q_OBJECT
public:
  account_indexView() : TActionView() { }
  QString toString();
};

QString account_indexView::toString()
{
...
T_DEFINE_VIEW(account_indexView)

#include "account_indexView.moc"
