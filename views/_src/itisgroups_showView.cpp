...
class T_VIEW_EXPORT itisgroups_showView : public TActionView
{
  Q_OBJECT
public:
  itisgroups_showView() : TActionView() { }
  QString toString();
};

QString itisgroups_showView::toString()
{
  responsebody.reserve(4764);
  responsebody += QStringLiteral("<!DOCTYPE html>\n");
    tfetch(ItisGroups, itisGroups);
  ...
  responsebody += THttpUtility::htmlEscape(itisGroups.id());
  responsebody += QStringLiteral("\" readonly></p>\n<p><label>Groupname</label><input class=\"w3-input\" type=\"text\" value=\"");
  responsebody += THttpUtility::htmlEscape(itisGroups.groupname());
  responsebody += QStringLiteral("\" readonly></p>\n<p><label>Groupdesc</label><input class=\"w3-input\" type=\"text\" value=\"");
...
T_DEFINE_VIEW(itisgroups_showView)

#include "itisgroups_showView.moc"
