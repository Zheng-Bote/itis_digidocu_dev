...
class T_VIEW_EXPORT catclasses_indexView : public TActionView
{
  Q_OBJECT
public:
  catclasses_indexView() : TActionView() { }
  QString toString();
};

QString catclasses_indexView::toString()
{
  responsebody.reserve(2527);
...
T_DEFINE_VIEW(catclasses_indexView)

#include "catclasses_indexView.moc"
