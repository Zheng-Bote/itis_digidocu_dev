...
class T_VIEW_EXPORT acclasses_indexView : public TActionView
{
  Q_OBJECT
public:
  acclasses_indexView() : TActionView() { }
  QString toString();
};

QString acclasses_indexView::toString()
{
  responsebody.reserve(2734);
...
T_DEFINE_VIEW(acclasses_indexView)

#include "acclasses_indexView.moc"
