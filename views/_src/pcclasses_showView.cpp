...
class T_VIEW_EXPORT pcclasses_showView : public TActionView
{
  Q_OBJECT
public:
  pcclasses_showView() : TActionView() { }
  QString toString();
};

QString pcclasses_showView::toString()
{
  responsebody.reserve(4945);
  responsebody += QStringLiteral("<!DOCTYPE html>\n");
    tfetch(PcClasses, pcClasses);
  ...
  responsebody += QStringLiteral("\" readonly></p>\n<p><label>Pc Class</label><input class=\"w3-input\" type=\"text\" value=\"");
...
T_DEFINE_VIEW(pcclasses_showView)

#include "pcclasses_showView.moc"
