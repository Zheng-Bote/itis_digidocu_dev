...
class T_VIEW_EXPORT webmenu_indexView : public TActionView
{
  Q_OBJECT
public:
  webmenu_indexView() : TActionView() { }
  QString toString();
};

QString webmenu_indexView::toString()
{
...
T_DEFINE_VIEW(webmenu_indexView)

#include "webmenu_indexView.moc"
