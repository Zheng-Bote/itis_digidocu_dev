...
class T_VIEW_EXPORT itisgroups_indexView : public TActionView
{
  Q_OBJECT
public:
  itisgroups_indexView() : TActionView() { }
  QString toString();
};

QString itisgroups_indexView::toString()
{
  responsebody.reserve(2529);
...
T_DEFINE_VIEW(itisgroups_indexView)

#include "itisgroups_indexView.moc"
