...
class T_VIEW_EXPORT actionrights_indexView : public TActionView
{
  Q_OBJECT
public:
  actionrights_indexView() : TActionView() { }
  QString toString();
};

QString actionrights_indexView::toString()
{
  responsebody.reserve(2531);
...
T_DEFINE_VIEW(actionrights_indexView)

#include "actionrights_indexView.moc"
