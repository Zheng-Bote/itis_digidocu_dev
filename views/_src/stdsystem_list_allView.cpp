...
class T_VIEW_EXPORT stdsystem_list_allView : public TActionView
{
  Q_OBJECT
public:
  stdsystem_list_allView() : TActionView() { }
  QString toString();
};

QString stdsystem_list_allView::toString()
{
  responsebody.reserve(5128);
  ...
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.stdVal());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.stdFlag());
  responsebody += QStringLiteral("</td>\n    <td>");
...
T_DEFINE_VIEW(stdsystem_list_allView)

#include "stdsystem_list_allView.moc"
