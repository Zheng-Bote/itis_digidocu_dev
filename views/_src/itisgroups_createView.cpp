...
class T_VIEW_EXPORT itisgroups_createView : public TActionView
{
  Q_OBJECT
public:
  itisgroups_createView() : TActionView() { }
  QString toString();
};

QString itisgroups_createView::toString()
{
  responsebody.reserve(3720);
  ...
  responsebody += QStringLiteral("\n  <p>\n    <label>Groupname<br /><input class=\"w3-input\" name=\"itisGroups[groupname]\" value=\"");
  responsebody += THttpUtility::htmlEscape(itisGroups["groupname"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Groupdesc<br /><input class=\"w3-input\" name=\"itisGroups[groupdesc]\" value=\"");
  responsebody += THttpUtility::htmlEscape(itisGroups["groupdesc"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Active<br /><input class=\"w3-input\" name=\"itisGroups[active]\" value=\"");
  responsebody += THttpUtility::htmlEscape(itisGroups["active"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <input type=\"submit\" value=\"Create &raquo;\" />\n  </p>\n  </div>\n</form>\n\n<br/>\n<a href=\"/itisGroups/show/");
  responsebody += THttpUtility::htmlEscape(itisGroups["id"]);
  responsebody += QStringLiteral("\" class=\"w3-btn w3-light-grey\"><img src=\"/Icons/eyeglasses.svg\">&nbsp;Anzeige</a>\n<a href=\"/itisGroups/list_all\" class=\"w3-btn w3-light-grey\">&laquo;&nbsp;zur&uuml;ck</a>\n\n</main>\n\n<itis-footer id=\"itisFooter\" message=\"\"></itis-footer>\n</body>\n</html>\n\n");

  return responsebody;
}

T_DEFINE_VIEW(itisgroups_createView)

#include "itisgroups_createView.moc"
