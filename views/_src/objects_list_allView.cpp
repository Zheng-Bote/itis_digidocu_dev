...
class T_VIEW_EXPORT objects_list_allView : public TActionView
{
  Q_OBJECT
public:
  objects_list_allView() : TActionView() { }
  QString toString();
};

QString objects_list_allView::toString()
{
  responsebody.reserve(5393);
...
T_DEFINE_VIEW(objects_list_allView)

#include "objects_list_allView.moc"
