...
class T_VIEW_EXPORT pcclasses_indexView : public TActionView
{
  Q_OBJECT
public:
  pcclasses_indexView() : TActionView() { }
  QString toString();
};

QString pcclasses_indexView::toString()
{
  responsebody.reserve(2736);
...
T_DEFINE_VIEW(pcclasses_indexView)

#include "pcclasses_indexView.moc"
