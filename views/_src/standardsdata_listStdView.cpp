...
class T_VIEW_EXPORT standardsdata_listStdView : public TActionView
{
  Q_OBJECT
public:
  standardsdata_listStdView() : TActionView() { }
  QString toString();
};

QString standardsdata_listStdView::toString()
{
...
T_DEFINE_VIEW(standardsdata_listStdView)

#include "standardsdata_listStdView.moc"
