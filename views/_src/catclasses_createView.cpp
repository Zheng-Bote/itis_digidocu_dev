...
class T_VIEW_EXPORT catclasses_createView : public TActionView
{
  Q_OBJECT
public:
  catclasses_createView() : TActionView() { }
  QString toString();
};

QString catclasses_createView::toString()
{
  responsebody.reserve(5361);
  ...
  responsebody += QStringLiteral("\n<div class=\"w3-container\" style=\"max-width: 50%;\">\n  <p>\n    <label>Cat Lname De<br /><input class=\"w3-input\"  name=\"catClasses[catLnameDe]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["catLnameDe"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Cat Sname De<br /><input class=\"w3-input\"  name=\"catClasses[catSnameDe]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["catSnameDe"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Desc De<br /><input class=\"w3-input\"  name=\"catClasses[descDe]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["descDe"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Cat Lname En<br /><input class=\"w3-input\"  name=\"catClasses[catLnameEn]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["catLnameEn"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Cat Sname En<br /><input class=\"w3-input\"  name=\"catClasses[catSnameEn]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["catSnameEn"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Desc En<br /><input class=\"w3-input\"  name=\"catClasses[descEn]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["descEn"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Class Type<br /><input class=\"w3-input\"  name=\"catClasses[classType]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["classType"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Groups<br /><input class=\"w3-input\"  name=\"catClasses[groups]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["groups"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Sort<br /><input class=\"w3-input\"  name=\"catClasses[sort]\" value=\"");
  responsebody += THttpUtility::htmlEscape(catClasses["sort"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Active<br /><input class=\"w3-input\"  name=\"catClasses[active]\" value=\"");
...
T_DEFINE_VIEW(catclasses_createView)

#include "catclasses_createView.moc"
