...
class T_VIEW_EXPORT account_createView : public TActionView
{
  Q_OBJECT
public:
  account_createView() : TActionView() { }
  QString toString();
};

QString account_createView::toString()
{
  responsebody.reserve(7276);
