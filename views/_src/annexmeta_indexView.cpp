...
class T_VIEW_EXPORT annexmeta_indexView : public TActionView
{
  Q_OBJECT
public:
  annexmeta_indexView() : TActionView() { }
  QString toString();
};

QString annexmeta_indexView::toString()
{
  responsebody.reserve(3176);
  responsebody += QStringLiteral("<!DOCTYPE html>\n");
    responsebody += QStringLiteral("<html>\n<head>\n  <meta charset=\"UTF-8\">\n  <title>");
  responsebody += THttpUtility::htmlEscape(controller()->name() + ": " + controller()->activeAction());
  responsebody += QStringLiteral("</title>\n</head>\n<body>\n\n<h1>Listing Annex Meta</h1>\n\n<p id=\"redmsg\" style=\"color: red\">");
  techoex(red_msg);
  tehex(error);
  ...
  responsebody += QVariant(linkTo("Create a new Annex Meta", urla("create"))).toString();
  responsebody += QStringLiteral("<br />\n<br />\n<table border=\"1\" cellpadding=\"5\" style=\"border: 1px #d0d0d0 solid; border-collapse: collapse;\">\n  <tr>\n    <th>ID</th>\n    <th>Spec Data ID</th>\n    <th>Spec Created</th>\n    <th>Spec Last Modified</th>\n    <th>Spec Valid Start</th>\n    <th>Spec Valid End</th>\n    <th>Last Editor</th>\n    <th>G Legacy</th>\n    <th>Responsibility</th>\n    <th>Spec Comment</th>\n    <th>Spec Marker</th>\n    <th>Groups</th>\n  </tr>\n");
  tfetch(QList<AnnexMeta>, annexMetaList);
  for (const auto &i : annexMetaList) {
...
T_DEFINE_VIEW(annexmeta_indexView)

#include "annexmeta_indexView.moc"
