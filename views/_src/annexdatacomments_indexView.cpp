...
class T_VIEW_EXPORT annexdatacomments_indexView : public TActionView
{
  Q_OBJECT
public:
  annexdatacomments_indexView() : TActionView() { }
  QString toString();
};

QString annexdatacomments_indexView::toString()
{
  responsebody.reserve(2811);
...
T_DEFINE_VIEW(annexdatacomments_indexView)

#include "annexdatacomments_indexView.moc"
