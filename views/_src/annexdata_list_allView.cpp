...
class T_VIEW_EXPORT annexdata_list_allView : public TActionView
{
  Q_OBJECT
public:
  annexdata_list_allView() : TActionView() { }
  QString toString();
};

QString annexdata_list_allView::toString()
{
  responsebody.reserve(6474);
  ...
  tfetch(QList<AnnexData>, annexDataList);
  for (const auto &i : annexDataList) {
...
T_DEFINE_VIEW(annexdata_list_allView)

#include "annexdata_list_allView.moc"
