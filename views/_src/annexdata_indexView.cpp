...
class T_VIEW_EXPORT annexdata_indexView : public TActionView
{
  Q_OBJECT
public:
  annexdata_indexView() : TActionView() { }
  QString toString();
};

QString annexdata_indexView::toString()
{
  responsebody.reserve(2582);
...
T_DEFINE_VIEW(annexdata_indexView)

#include "annexdata_indexView.moc"
