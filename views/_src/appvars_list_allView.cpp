...
class T_VIEW_EXPORT appvars_list_allView : public TActionView
{
  Q_OBJECT
public:
  appvars_list_allView() : TActionView() { }
  QString toString();
};

QString appvars_list_allView::toString()
{
  responsebody.reserve(5377);
  ...
  responsebody += QStringLiteral("</span> ");
  tehex(notice);
  responsebody += QStringLiteral("</p>\n\n<main>\n<div id=\"pagecontent\"><page-content message=\"\"><article><p>Handhabung:<br/>im Baustein die Variable in 2 Klammern (curly brackets) einschliessen.</p><p>integrierte Variablen:<ul><li>{{YYYY}} : Jahreszahl</li><li>{{MM}} : Monatszahl</li></ul></p></article></page-content></div>\n\n<br />\n<table class=\"w3-table-all w3-hoverable sortable\" id=\"myTable\">\n  <tr class=\"w3-text-grey\">\n    <th>ID</th>\n    <th>Std Type</th>\n    <th>Std Attr</th>\n    <th>Std Val De</th>\n    <th>Std Val En</th>\n    <th>Active</th>\n    <th style=\"width:120px;\">Baustein</th>\n  </tr>\n");
  tfetch(QList<AppVars>, appVarsList);
  for (const auto &i : appVarsList) {
  responsebody += QStringLiteral("  <tr>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.id());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.stdType());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.stdAttr());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.stdValDe());
  responsebody += QStringLiteral("</td>\n    <td>");
  responsebody += THttpUtility::htmlEscape(i.stdValEn());
  responsebody += QStringLiteral("</td>\n    <td>");
...
T_DEFINE_VIEW(appvars_list_allView)

#include "appvars_list_allView.moc"
