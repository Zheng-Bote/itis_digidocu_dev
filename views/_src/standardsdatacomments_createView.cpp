...
class T_VIEW_EXPORT standardsdatacomments_createView : public TActionView
{
  Q_OBJECT
public:
  standardsdatacomments_createView() : TActionView() { }
  QString toString();
};

QString standardsdatacomments_createView::toString()
{
  responsebody.reserve(4766);
  ...
  responsebody += QStringLiteral("\n<div class=\"w3-container\" style=\"max-width: 50%;\">\n  <p>\n    <label>Comment Created<br /><input  class=\"w3-input\" name=\"standardsDataComments[commentCreated]\" value=\"");
  responsebody += THttpUtility::htmlEscape(standardsDataComments["commentCreated"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Spec ID<br /><input class=\"w3-input\" name=\"standardsDataComments[specId]\" value=\"");
  responsebody += THttpUtility::htmlEscape(standardsDataComments["specId"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Spec Title<br /><input class=\"w3-input\" name=\"standardsDataComments[specTitle]\" value=\"");
  responsebody += THttpUtility::htmlEscape(standardsDataComments["specTitle"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Spec Version<br /><input class=\"w3-input\" name=\"standardsDataComments[specVersion]\" value=\"");
  responsebody += THttpUtility::htmlEscape(standardsDataComments["specVersion"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>User Comment<br /><input class=\"w3-input\" name=\"standardsDataComments[userComment]\" value=\"");
  responsebody += THttpUtility::htmlEscape(standardsDataComments["userComment"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Username<br /><input class=\"w3-input\" name=\"standardsDataComments[username]\" value=\"");
...
T_DEFINE_VIEW(standardsdatacomments_createView)

#include "standardsdatacomments_createView.moc"
