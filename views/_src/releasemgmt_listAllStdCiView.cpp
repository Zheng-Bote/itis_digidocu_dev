...
class T_VIEW_EXPORT releasemgmt_listAllStdCiView : public TActionView
{
  Q_OBJECT
public:
  releasemgmt_listAllStdCiView() : TActionView() { }
  QString toString();
};

QString releasemgmt_listAllStdCiView::toString()
{
  responsebody.reserve(6334);
...
T_DEFINE_VIEW(releasemgmt_listAllStdCiView)

#include "releasemgmt_listAllStdCiView.moc"
