...
class T_VIEW_EXPORT pcclasses_list_allView : public TActionView
{
  Q_OBJECT
public:
  pcclasses_list_allView() : TActionView() { }
  QString toString();
};

QString pcclasses_list_allView::toString()
{
  responsebody.reserve(4876);
  ...
  tfetch(QList<PcClasses>, pcClassesList);
  for (const auto &i : pcClassesList) {
...
T_DEFINE_VIEW(pcclasses_list_allView)

#include "pcclasses_list_allView.moc"
