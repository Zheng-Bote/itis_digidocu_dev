...
class T_VIEW_EXPORT webmenu_createView : public TActionView
{
  Q_OBJECT
public:
  webmenu_createView() : TActionView() { }
  QString toString();
};

QString webmenu_createView::toString()
{
  responsebody.reserve(5420);
  ...
  responsebody += QStringLiteral("\n<div class=\"w3-container\" style=\"max-width: 50%;\">\n  <p>\n    <label>Mnu ID<br /><input class=\"w3-input\" name=\"webmenu[mnuId]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["mnuId"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Mnu Sub ID<br /><input class=\"w3-input\" name=\"webmenu[mnuSubId]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["mnuSubId"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Name De<br /><input class=\"w3-input\" name=\"webmenu[nameDe]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["nameDe"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Desc De<br /><input class=\"w3-input\" name=\"webmenu[descDe]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["descDe"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Name En<br /><input class=\"w3-input\" name=\"webmenu[nameEn]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["nameEn"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Desc En<br /><input class=\"w3-input\" name=\"webmenu[descEn]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["descEn"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Mnu Uri<br /><input class=\"w3-input\" name=\"webmenu[mnuUri]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["mnuUri"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Groups<br /><input class=\"w3-input\" name=\"webmenu[groups]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["groups"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Mnu Item<br /><input name=\"webmenu[mnuItem]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["mnuItem"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Sort<br /><input class=\"w3-input\" name=\"webmenu[sort]\" value=\"");
  responsebody += THttpUtility::htmlEscape(webmenu["sort"]);
  responsebody += QStringLiteral("\" /></label>\n  </p>\n  <p>\n    <label>Active<br /><input class=\"w3-input\" name=\"webmenu[active]\" value=\"");
...
T_DEFINE_VIEW(webmenu_createView)

#include "webmenu_createView.moc"
